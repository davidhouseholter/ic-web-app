...
module {
  ...
  public class Access(
    init : {
    admin : Principal;
    itemsOwned : RelObj.RelObj<Types.UserId, Types.ItemId>
  } )
  {
    ...
    public var userRole : RelObj.RelObj<Types.UserId, Types.Role> = RelObj.RelObj<Types.UserId, Role.Role> ((Text.hash, Role.hash), (Text.equal, Role.equal));
               ...
               switch userAction_ {
                 ...
                 case (#update) {
                        switch actionTarget_ {
                          ...
                          case (#item v) {
                                 let users = init.itemsOwned.get1(v);
                                 switch (users.size()) {
